                ...
                {products && 
                    products.map((item)=>(
                        <div className='relative rounded-lg w-[300px] flex flex-col justify-center items-center'>
                            ...
                            <div className="flex gap-4 pt-[20px] px-[50px]">
                                <Rating className='' name="read-only" value={item.rating.rate} />
                                <div className="category text-[#eb64fa]">{item.category.includes("clothing")?<div className='text-[#b164fa]'>Clothing</div>:<div className='text-[#b164fa]'>Jewelery</div>}</div>
                            </div>
                        </div>
                    ))
                }
