...
const Products = () => {
    const filter = ["clothing","jewellers","men","women","electronics"]
            ...
            <div className="flex justify-center flex-col items-center">
                <div className="flex justify-around pt-4 w-full">
                    <div className="flex gap-x-2 ">
                        {filter.map((item)=> <div className='bg-[#ffffff] opacity-50  text-[#97bf0d] px-2 rounded-full p-1'>
                            {item}</div>
                            )}
                    </div>
                    <div></div>
                ...
                <div className='grid grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-y-[15px]'>
                    {products && !selectedFilter.length &&
